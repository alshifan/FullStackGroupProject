...
/* harmony import */ var _CreateForm_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CreateForm.jsx */ "./jsx/CreateForm.jsx");
...
// Get param values
var getParamsValue = function getParamsValue(CreateEmployee) {
  return function (props) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(CreateEmployee, _extends({}, props, {
      urlParams: (0,react_router_dom__WEBPACK_IMPORTED_MODULE_2__.useParams)(),
      navigate: (0,react_router_dom__WEBPACK_IMPORTED_MODULE_2__.useNavigate)()
    }));
  };
};
var CreateEmployee = /*#__PURE__*/function (_React$Component) {
  function CreateEmployee(props) {
    var _this;
    _classCallCheck(this, CreateEmployee);
    _this = _callSuper(this, CreateEmployee, [props]);
    ...
    _defineProperty(_this, "handleSubmit", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
        var _this$state, firstName, lastName, age, dateOfJoining, title, department, employeeType, employee, query, variables, _query, _variables;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              event.preventDefault();
              _this$state = _this.state, firstName = _this$state.firstName, lastName = _this$state.lastName, age = _this$state.age, dateOfJoining = _this$state.dateOfJoining, title = _this$state.title, department = _this$state.department, employeeType = _this$state.employeeType; // Basic validation
            ...
            case 13:
              ...
              employee._id = _this.props.urlParams.id;
              _variables = {
                employee: employee
              };
              _context.next = 18;
  ...
  _inherits(CreateEmployee, _React$Component);
  return _createClass(CreateEmployee, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var id = this.props.urlParams.id;
      if (id) {
        this.setState({
          isEditMode: true
        });
    ...
    key: "loadEmployeeDetail",
    value: function () {
      var _loadEmployeeDetail = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
        var _this2 = this;
        var query;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              query = "query GetEmployee($employeeId: String) {\n                        getEmployee(employeeId: $employeeId) {\n                            firstName\n                            lastName\n                            age\n                            dateOfJoining\n                            title\n                            department\n                            employeeType\n                            _id\n                            currentStatus\n                        }\n                    }";
              _context3.next = 3;
              return fetch('/graphql', {
                method: 'POST',
                headers: {
                ...
                var data = _ref3.data;
                var _data$getEmployee = data.getEmployee,
                  firstName = _data$getEmployee.firstName,
                  lastName = _data$getEmployee.lastName,
                  age = _data$getEmployee.age,
                  dateOfJoining = _data$getEmployee.dateOfJoining,
                  title = _data$getEmployee.title,
                  department = _data$getEmployee.department,
                  employeeType = _data$getEmployee.employeeType,
                  currentStatus = _data$getEmployee.currentStatus;
                _this2.setState({
                  firstName: firstName,
                  lastName: lastName,
                  age: age,
      ...
      function loadEmployeeDetail(_x2) {
        return _loadEmployeeDetail.apply(this, arguments);
      }
      return loadEmployeeDetail;
    }()
  }, {
    key: "resetForm",
    ...
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_CreateForm_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], {
        state: this.state,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getParamsValue(CreateEmployee));
...
var CreateForm = /*#__PURE__*/function (_React$Component) {
  function CreateForm() {
    ...
    return _callSuper(this, CreateForm, arguments);
  }
  _inherits(CreateForm, _React$Component);
  return _createClass(CreateForm, [{
    key: "render",
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("form", {
        ...
        value: "Director"
      }, "Director")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("select", {
        name: "department",
        ...
        value: "Seasonal"
      }, "Seasonal")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("select", {
        name: "currentStatus",
...
// Get param values
var getParamsValue = function getParamsValue(EmployeeDetails) {
  return function (props) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(EmployeeDetails, _extends({}, props, {
      urlParams: (0,react_router_dom__WEBPACK_IMPORTED_MODULE_1__.useParams)()
    }));
  };
};
var EmployeeDetails = /*#__PURE__*/function (_React$Component) {
  ...
  return _createClass(EmployeeDetails, [{
    ...
    key: "loadData",
    value: function () {
      var _loadData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
        var _this2 = this;
        var query;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return fetch('/graphql', {
                ...
                var data = _ref2.data;
                var employeeDetails = data.getEmployee;
                _this2.setState({
    ...
    value: function render() {
      var _this$state = this.state,
        employeeDetails = _this$state.employeeDetails,
        isLoading = _this$state.isLoading;
      if (isLoading) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Loading...");
      }
      return employeeDetails && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        className: "employee-details-container"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Employee Details"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        className: "employee-card"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, employeeDetails.firstName, " ", this.state.employeeDetails.lastName), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Age:"), " ", employeeDetails.age), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Joining Date:"), " ", employeeDetails.dateOfJoining), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Title:"), " ", employeeDetails.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Department:"), " ", employeeDetails.department), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Employment Type:"), " ", employeeDetails.employeeType)));
    }
  }]);
}((react__WEBPACK_IMPORTED_MODULE_0___default().Component));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getParamsValue(EmployeeDetails));
...
var EmployeeDirectory = /*#__PURE__*/function (_React$Component) {
  function EmployeeDirectory() {
    ...
    _defineProperty(_this, "filterEmployees", function (filterCriteria) {
      var filtered = _this.state.employees.filter(function (employee) {
        return Object.keys(filterCriteria).every(function (key) {
          var filterValue = filterCriteria[key].trim().toLowerCase();
          var employeeValue = employee[key] ? employee[key].toString().toLowerCase() : '';
    ...
    _defineProperty(_this, "handleEmployeeTypeChange", function (event) {
      var employeeType = event.target.value;
      _this.setState({
        employeeType: employeeType
      });
      _this.loadData(employeeType);
    });
    _defineProperty(_this, "handleDeleteEmployee", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              query = "query RemoveEmployee($employeeId: String) {\n                    removeEmployee(employeeId: $employeeId) {\n                      message\n                    }\n                  }";
              _context2.next = 3;
              return fetch('/graphql', {
                method: 'POST',
                headers: {
                ...
                _this.loadData(_this.state.employeeType);
              }).catch(function (error) {
                console.error('Error', error);
              });
            case 3:
  ...
  return _createClass(EmployeeDirectory, [{
    ...
    key: "loadData",
    value: function () {
      var _loadData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(employeeType) {
    ...
    value: function render() {
      var _this2 = this;
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Employee Management System"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_EmployeeSearch_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], {
        employeeType: this.state.employeeType,
        handleInputChange: this.handleEmployeeTypeChange
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_EmployeeTable_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], {
        employees: this.state.filteredEmployees,
        handleDeleteEmployee: function handleDeleteEmployee(id) {
          return _this2.handleDeleteEmployee(id);
        }
      }));
    }
  }]);
...
var getNavigation = function getNavigation(EmployeeTable) {
  return function (props) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(EmployeeTable, _extends({}, props, {
...
var EmployeeTable = /*#__PURE__*/function (_React$Component) {
  function EmployeeTable() {
    ...
    _defineProperty(_this, "handleDetailsClick", function (id) {
      _this.props.navigate("/details/".concat(id));
    });
    _defineProperty(_this, "handleEditClick", function (id) {
      _this.props.navigate("/edit/".concat(id));
    });
    _defineProperty(_this, "handleDeleteClick", function (id) {
      _this.props.handleDeleteEmployee(id);
    });
    return _this;
  }
  ...
  return _createClass(EmployeeTable, [{
    ...
    value: function render() {
      ...
      if (!employees || employees.length === 0) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, "No employees to display.");
      }
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getNavigation(EmployeeTable));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router/dist/development/chunk-GNGMS2XR.mjs");
...
/* harmony import */ var _CreateEmployee_jsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./CreateEmployee.jsx */ "./jsx/CreateEmployee.jsx");
/* harmony import */ var _Navbar_jsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Navbar.jsx */ "./jsx/Navbar.jsx");
...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  return _createClass(Main, [{
    ...
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__.HashRouter, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Navbar_jsx__WEBPACK_IMPORTED_MODULE_4__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        ...
        path: "/create",
        element: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_CreateEmployee_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], null)
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__.Route, {
        path: "/edit/:id",
        element: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_CreateEmployee_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], null)
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__.Route, {
...
react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot(document.getElementById('root')).render(/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Main, null));
...
function Navbar() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("nav", {
    ...
    to: "/",
    className: "nav-link"
  }, "Employees"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.NavLink, {
    to: "/create",
    className: "nav-link"
  }, "Add Employee")));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor"], () => (__webpack_require__("./jsx/Main.jsx")))
